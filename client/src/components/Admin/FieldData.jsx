...
const FieldDataa = () => {
  ...
  const fetchDataList = async () => {
    ...
    try {
      ...
      // extract unique executive codes for filtering
  ...
  useEffect(() => {
    if (selectedExecutive === "All") {
      ...
      setFilteredData(dataList.filter((item) => item.executiveCode === selectedExecutive));
    }
  }, [selectedExecutive, dataList]);
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-4 flex justify-end">
        <label className="font-semibold mr-2">Filter by Executive:</label>
        <select
